                            ...
                            <form action="{{ route('cart', $product->id) }}" method="POST">
                                ...
                                <div class="product-options">
                                    ...
                                    <table class="table table-bordered table-striped mb-5">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ number_format($product->weight, 0) }}</td>
                                                <td>
                                                    <span class="discounted-rate" style="font-weight: bold; color: #3CB815;">
                                                ...
                                                <td>
                                                    <input class="form-check-input" type="radio" name="quantity" id="quantity" value="{{ $product->weight }}">
                                                </td>
                                            </tr>
                                            @foreach($product->discounts as $discount)
                                                <tr>
                                                    <td>{{ number_format($discount->weight, 0) }}</td>
                                                    <td>
                                                        <span class="discounted-rate" style="font-weight: bold; color: #3CB815;">
                                                            Rs {{ number_format($discount->discounted_price, 2) }}
                                                        </span>
                                                    </td>
                                                    <td style="color: #dc3545;">
                                                        Only {{ $product->stock }} limited stock
