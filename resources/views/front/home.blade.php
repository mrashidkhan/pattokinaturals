        ...
        <div class="container-fluid p-0"style="margin-top: 70px;">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img id="carousel-img-1" src="img/caraousel-1.png" class="d-block w-100" alt="..."
                        style="max-width: 100%; height: auto;">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img id="carousel-img-2" src="img/carousel-2.png" class="d-block w-100" alt="..."
                        style="max-width: 100%; height: auto;">
                </div>
            </div>
        </div>
                        ...
                        <a href="{{ route('productview', $value->id) }}">
                            ...
                            <div class="bg-light p-4">
                                <a class="d-block h5 lh-base mb-4"
                                    href="{{ route('productview', $value->id) }}">{{ $value->name }}</a>
                                <i class="fa fa-tag text-primary me-2"></i><small class="text-dark">Rs.
                                    {{ number_format($value->base_price) }}</small>
                                <i
                                    class="fa fa-calendar text-primary me-2"></i><small>{{ $value->updated_at->format('d M Y') }}</small>
