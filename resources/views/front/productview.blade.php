                                ...
                                <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                    ...
                                    <div class="product-options">
                                        ...
                                        @foreach ($product->discounts as $discount)
                                            <div class="form-check border border-dark p-3 mb-2 ml-5 mr-5 discount-option"
                                                style="border-radius: 5px;">
                                                <input class="form-check-input" type="radio" name="weight"
                                                    id="quantity{{ $loop->index }}" value="{{ $discount->weight }}"
                                                    {{ $loop->first ? 'checked' : '' }}
                                                ...
                                                <label class="form-check-label" for="quantity{{ $loop->index }}">
                                                    ...
                                                    <span class="discounted-rate"
                                                        style="font-size: 1.2em; font-weight: bold;">Rs
                                                        {{ number_format($discount->discounted_price, 2) }}</span>
                                                </label>
                                                <div class="stock-message" style="font-size: 0.9em; color: #dc3545;">
                                                    Only {{ $product->stock }} limited stock |
                                                    <span class="original-price"
                                                        style="text-decoration: line-through; color: #6c757d;">
                                    ...
                                    <input type="hidden" name="discount_id" id="selected_discount_id"
                                        value="{{ $product->discounts->first()->id }}">
